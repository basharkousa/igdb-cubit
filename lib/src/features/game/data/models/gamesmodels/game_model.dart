...
import './subclasses/cover_model.dart';
import './subclasses/genre_model.dart';
import './subclasses/player_perspective_model.dart';
import './subclasses/screenshot_model.dart';
import './subclasses/video_model.dart';
class GameModel {
  GameModel({
    int? id,
    double? rating,
  ...
  Game toGame(bool isFavourite) {
    return Game(
        ...
        screenshots: screenshots?.map((item) => ScreenShot(imageId: item.id.toString(), link: "https://images.igdb.com/igdb/image/upload/t_screenshot_big/${item.imageId}.jpg"))
            .toList(),
        summary: summary);
  }
