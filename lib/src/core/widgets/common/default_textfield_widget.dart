...
import 'package:igameapp/src/core/utils/countrys.dart';
import 'package:igameapp/src/core/utils/validator.dart';
  ...
  Widget buildCountryCodePicker() {
    return SizedBox(
      ...
      child: CountryCodePicker(
        ...
        flagWidth: 22.w,
        boxDecoration: BoxDecoration(color: context.scaffoldBackground),
        showCountryOnly: true,
        hideSearch: true,
        enabled: false,
        backgroundColor: Colors.transparent,
        barrierColor: Colors.transparent,
        closeIcon: Icon(Icons.close_rounded, color: context.hintColor),
        ...
        hideMainText: true,
        textStyle: TextStyle(color: context.hintColor),
        initialSelection: 'SA',
    ...
    switch (textValidType) {
      ...
      case TextValidType.PHONE:
        return (value) {
          ...
          // bool isValid = GetUtil.isPhoneNumber(value);
