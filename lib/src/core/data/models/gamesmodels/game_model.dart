import 'package:igameapp/src/core/data/models/gamesmodels/subclasses/cover_model.dart';
import 'package:igameapp/src/core/data/models/gamesmodels/subclasses/genre_model.dart';
import 'package:igameapp/src/core/data/models/gamesmodels/subclasses/player_perspective_model.dart';
import 'package:igameapp/src/core/data/models/gamesmodels/subclasses/screenshot_model.dart';
import 'package:igameapp/src/core/data/models/gamesmodels/subclasses/video_model.dart';
class GameModel {
  GameModel({
    int? id,
    double? rating,
