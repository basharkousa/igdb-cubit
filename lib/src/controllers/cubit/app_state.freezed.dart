...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Locale locale, GlobalKey<NavigatorState>? navigatorKey});
}
...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({this.locale = const Locale("en"), this.navigatorKey});
  ...
  @override
  String toString() {
    return 'AppState(locale: $locale, navigatorKey: $navigatorKey)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, locale, navigatorKey);
